  ...
  rooms: [
    {
      ...
      photos: [
        { name: "matrimonial-ambiente", caption: "Ambiente" },
        { name: "matrimonial-dormitorio", caption: "Cama Queen" },
        { name: "matrimonial-balcon", caption: "Balcón" },
        { name: "matrimonial-vista", caption: "Vista al mar" },
        { name: "matrimonial-bano", caption: "Baño" },
        { name: "matrimonial-detalle", caption: "Detalles" },
      ],
      description:
    ...
    },
    {
      ...
      clips: [
        ...
        { label: "Vista al mar", text: "El mar desde la ventana esquinera.", video: "doble-vista", photo: "doble-vista" },
        { label: "Dos camas", text: "Se pueden unir para formar una Queen.", video: "doble-camas", photo: "doble-camas" },
        { label: "Baño", text: "Baño completo con ducha.", video: "doble-bano", photo: "doble-bano" },
        { label: "Detalles", text: "Amenities y toallas del hotel.", video: "doble-detalles", photo: "doble-detalle", portrait: true },
      ...
      photos: [
        { name: "doble-dormitorio", caption: "Dos camas individuales" },
        { name: "doble-vista", caption: "Vista al mar" },
        { name: "doble-camas", caption: "Camas unidas en Queen" },
        { name: "doble-bano", caption: "Baño" },
        { name: "doble-adaptada", caption: "Habitación adaptada" },
        { name: "doble-detalle", caption: "Detalles" },
      ],
      description:
    ...
    },
    {
      ...
      clips: [
        ...
        { label: "Baño", text: "Doble bacha bajo la claraboya.", video: "suite-bano", photo: "suite-bano", portrait: true },
      ],
      photos: [
        { name: "suite-panoramica", caption: "La suite completa" },
        { name: "suite-dormitorio", caption: "Cama Queen" },
        { name: "suite-estar", caption: "Área de estar" },
        { name: "suite-claraboya", caption: "Claraboyas" },
        { name: "suite-bano", caption: "Baño" },
        { name: "suite-ducha", caption: "Ducha escocesa" },
      ],
      description:
